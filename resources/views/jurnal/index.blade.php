                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <a href="{{ route('jurnal.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            Tambah</a>
                        <a href="{{ url('jurnal-excel') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                            Export To Excel</a>
                        <a href="{{ url('jurnal-pdf') }}" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm" i class="bi bi-filetype-pdf" title="Export To PDF">
                            </i>PDF</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <form method="POST" action="{{ route('jurnal.destroy', $row->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{ route('jurnal.show', $row->id) }}" class=" btn  btn-primary shadow-sm  text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                    Detail
                                                </a>
                                                &nbsp;
                                                ...
                                                &nbsp;
                                                <button type="submit" class="btn btn-danger shadow-sm text-xs" onclick="return confirm('Anda yakin ingin hapus jurnal ini?')" data-toggle="tooltip" data-original-title="Edit user">
                                                    Hapus
                                                </button>
                                            </form>
                                        </td>
