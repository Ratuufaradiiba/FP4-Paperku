                    ...
                    <form class="row g-3" method="POST" action="{{ route('jurnal.update', $jurnal->id)}}"
                        ...
                        <div class="col-6">
                            ...
                            <select id="inputState" class="form-select" name="id_kategori">
                                ...
                                <option value="{{ $row->id }}" @if($row->id==$jurnal->id_kategori) selected
                                    @endif>{{ $row->nama_kategori }}</option>
                                @endforeach
                            </select>
                            @error('id_kategori')
                            <p class="text text-danger mb-0">{{ $message }}</p>
                        ...
                        <div class="col-6">
                            ...
                            <select id="inputState" class="form-select" name="id_profile">
                                ...
                                <option value="{{ $row->id }}" @if($row->id==$jurnal->id_profile) selected
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="isi" value="{{ old('isi', $jurnal->isi) }}">
                            @error('isi')
                            <p class="text text-danger mb-0">{{ $message }}</p>
                            @enderror
                        </div>
