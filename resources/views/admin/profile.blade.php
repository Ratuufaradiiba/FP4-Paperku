...
@section('content')
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4"
            style="background-image: url({{ url('assets/img/curved-images/curved0.jpg') }}) ; background-position-y: 50%;">
    ...
    <div class="col-12 mt-4">
        <div class="card mb-4">
            <div class="card-header pb-0 p-3">
                <h6 class="mb-1">Paperku</h6>
                <p class="text-sm">Upload Jurnal Terbaru</p>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                        <div class="card card-blog card-plain">
                            ...
                            <div class="card-body px-1 pb-0">
                                <p class="text-gradient text-dark mb-2 text-sm">Jurnal Teknologi Informasi</p>
                                <a href="javascript:;">
                                    <p><b>
                                            Sistem Pencegahan Gempa Bumi Di Indonesia
                                            <br>
                                            </br>
                                            <p>
                                        </b>
                    ...
                    <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                        <div class="card card-blog card-plain">
                            ...
                            <div class="card-body px-1 pb-0">
                                <p class="text-gradient text-dark mb-2 text-sm">Jurnal Pemasaran</p>
                                <a href="javascript:;">
                                    <p><b>
                                            Perencanaan perusahaan dan manajemen strategis oleh Nike Corporation
                                            <p>
                                        </b>
                                </a>
                                <p class="mb-4 text-sm">
