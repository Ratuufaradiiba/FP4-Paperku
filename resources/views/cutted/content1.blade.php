            ...
            <div class="card-body">
              <h3 class="h4 mb-3">
                <a class="post-title" href="post-details.html"
                  >Use apples to give your bakes caramel and a moist texture</a
                >
              </h3>
        ...
        <div class="col-lg-4 mb-5">
          ...
          <article class="card mb-4">
            <div class="card-body d-flex">
              ...
              <div class="ml-3">
                <h4>
                  <a href="post-details.html" class="post-title"
          ...
          <article class="card mb-4">
            <div class="card-body d-flex">
              ...
              <div class="ml-3">
                <h4>
                  <a href="post-details.html" class="post-title"
                    >The Design Files - Homes Minimalist</a
                  >
                </h4>
                <ul class="card-meta list-inline mb-0">
                  <li class="list-inline-item mb-0">
        ...
        <div class="col-lg-4 mb-5">
          ...
          <article class="card">
            ...
            <div class="card-body">
              <h3 class="h4 mb-3">
                <a class="post-title" href="post-details.html"
                  >How To Make Cupcakes and Cashmere Recipe At Home</a
                >
              </h3>
              <ul class="card-meta list-inline">
                <li class="list-inline-item">
