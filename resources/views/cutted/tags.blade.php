...
<head>
    <meta charset="utf-8">
    <title>Jurnal Kampus Merdeka|Kelompok 5</title>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="{{ url('images/1.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ url('images/1.png') }}" type="image/x-icon">
            ...
            <div class="row">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    ...
                    <article class="card mb-4">
                        ...
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" href="post/post-1/">Use apples to give your
