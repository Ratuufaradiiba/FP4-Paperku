        ...
        <div class="row justify-content-center">
            <div class="col-lg-8  mb-5 mb-lg-0">
                ...
                <article class="card mb-4">
                    ...
                    <div class="card-body">
                        <h3 class="mb-3"><a class="post-title" href="{{ route('postdetail') }}">{{ $row->judul}}</a></h3>
                        <ul class="card-meta list-inline">
                            ...
                            <li class="list-inline-item">
                                <ul class="card-meta-tag list-inline">
                                    <li class="list-inline-item"><a href="tags.html">{{ $row->kategori->nama_kategori }}</a></li>
                                </ul>
                            </li>
                        </ul>
                        <p>{{ $row->ket }}</p>
            ...
            <aside class="col-lg-4 @@sidebar">
                ...
                <div class="widget">
                    ...
                    <form action="#!" class="widget-search">
                        <input class="mb-3" id="search-query" name="proses" type="search" placeholder="Search for journal or paper..">
                        <i class="ti-search"></i>
                ...
                <div class="widget widget-categories">
                    ...
                    <ul class="list-unstyled widget-list">
                        @foreach ($kategori as $row)
                        <li><a href="tags.html" class="d-flex">{{ $row->nama_kategori }}<small class="ml-auto">(4)</small></a>
                        </li>
                        @endforeach
                    </ul>
                </div><!-- tags -->
