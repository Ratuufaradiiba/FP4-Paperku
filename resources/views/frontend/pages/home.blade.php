    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8  mb-5 mb-lg-0">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('landingpage/images/post/1.jpg') }}" class="card-img-top" alt="post-thumb">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('landingpage/images/post/5.jpg') }}" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('landingpage/images/post/6.jpg') }}" class="card-img-top" alt="post-thumb">
                        <img src="{{ asset('landingpage/images/post/7.jpg') }}" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                        <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes
                                and Cashmere Recipe At Home</a></h3>
