...
<section class="section">
    <div class="container">
        ...
        <div id="drop_zone">
            ...
            <p id="file_info"></p>
            <a href="{{url('/upload')}}">
                <p><button type="button" id="btn_file_pick" class="btn btn-primary"><span class="glyphicon glyphicon-folder-open"></span> Delete</button></p>
                <p id="file_info"></p>
            </a>
            ...
            <p><button type="button" id="btn_upload" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-up"></span> Upload Your File</button></p>
